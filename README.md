...
![Home Page](./src/assets/adminStatsPage1.png)
![Home Page](./src/assets/adminStatsPage2.png)
![Home Page](./src/assets/adminStatsPage3.png)

## Google Cloud Platform Response

![Google API Response](./src/assets/googleCloudPlatformResp.png)